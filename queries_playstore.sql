...
-- 8. SELECT * FROM analytics WHERE min_installs <= 50 AND rating IS NOT NULL ORDER BY results DESC;
-- 9. SELECT app_name FROM analytics WHERE rating < 3 AND reviews >= 10000;
-- 10. SELECT app_name FROM analytics WHERE price BETWEEN .1 AND 1 ORDER BY reviews DESC LIMIT 10;
-- 11. SELECT * FROM analytics ORDER BY last_updated LIMIT 1;
-- 12. SELECT * FROM analytics ORDER BY price DESC;
